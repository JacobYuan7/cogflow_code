...
from models import claude, gpt, Deepseek, CogFlow
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="llama3",
        help="llm engine",
        choices=["gpt-4o-mini","gpt-4o","cogflow"],
    )
    parser.add_argument(
    ...
    # load model
    if args.model == "gpt-4-turbo" or args.model == "gpt-4o-mini" or args.model == "gpt-4o":
        model = gpt.GPT_Model(args.model, '1', patience=5)
    elif args.model == "deepseek_v3":
        model = Deepseek.DeepSeek_v3()
    elif args.model == "cogflow":
